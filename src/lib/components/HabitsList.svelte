<script lang="ts">
	...
	import { Firestore, doc, collection, setDoc, addDoc, deleteDoc, query, orderBy } from "firebase/firestore";
	...
	async function addNewHabit() {
		...
		await addDoc(collection(firestore, "tracker", user.uid, "habits"), { name: newHabit, createdAt: timestamp });
		newHabit = "";
	}
